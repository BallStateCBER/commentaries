...
<?php 
	...
	echo $this->Html->css('/jquery_ui/css/smoothness/jquery-ui-1.10.0.custom.min.css', null, array('inline' => false));
	echo $this->Html->script('/jquery_ui/js/jquery-ui-1.10.0.custom.js', array('inline' => false));
